...
class AuctionHouse(Event):
    ...
    def mod(self):
        ...
        if self.args.auction_random_items:
            ...
            self.cherub_down_item = self.items.get_random(random_instance = random)
            self.cure_ring_item = self.items.get_random(random_instance = random)
            self.hero_ring_item = self.items.get_random(random_instance = random)
            self.zephyr_cape_item = self.items.get_random(random_instance = random)
